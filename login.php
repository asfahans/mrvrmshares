...
<head>
<meta charset="utf-8">
<title>VRM Share Broking Pvt. Ltd. | Admin Login</title>
<meta name="description" content="Admin login portal for VRM Share Broking Private Limited.">
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <main id="main-content">
        ...
        <div id="final-content">
            <!-- Login Form Section -->
            <section class="about-section" aria-label="Admin Login Portal">
                <div class="auto-container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-8 col-sm-12 mx-auto">
                            <div class="inner">
                                <div class="sec-title mb-4">
                                    <div class="upper-text">ADMIN PORTAL</div>
                                    <h2>Admin Login</h2>
                                </div>
                                <?php
                                if (isset($errorMessage) && $errorMessage != '') {
                                    echo '<div class="alert alert-danger mb-4" role="alert">' . htmlspecialchars($errorMessage) . '</div>';
                                }
                                ?>
                                <div class="text-content">
                                    <form method="post" action="login_process.php">
                                        <div class="form-group mb-3">
                                            <label for="email" class="form-label" style="font-weight: 600;">Email Address <span style="color:red;">*</span></label>
                                            <input type="email" class="form-control" id="email" name="email" required aria-required="true" autocomplete="email">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="password" class="form-label" style="font-weight: 600;">Password <span style="color:red;">*</span></label>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block py-2" style="font-weight: 600;">Login to Dashboard</button>
                                    </form>
                                </div>
                            </div>
                        </div>
